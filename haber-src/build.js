...
@media(max-width:900px){
  ...
  .catnav .wrap{justify-content:flex-start;padding:0 4px}
}
@media(max-width:520px){
  .lmrow{grid-template-columns:88px 1fr;gap:11px}
  .lmrow h4{font-size:16px}
  .catnav a{padding:14px 12px;font-size:11px;letter-spacing:.1em}
