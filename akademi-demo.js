...
(function () {
  ...
  var CSS = ''
    + '#akademi-demo{position:relative;background:#070a08;overflow:hidden;isolation:isolate}'
    // ayırt edici zemin: yeşile çalan karatahta + defter çizgisi dokusu
    + '#akademi-demo .ak-bgfx{position:absolute;inset:0;z-index:0;pointer-events:none;background:radial-gradient(circle 720px at 12% 0%,rgba(111,155,74,.10),transparent 60%),radial-gradient(circle 700px at 92% 100%,rgba(193,154,82,.08),transparent 58%),repeating-linear-gradient(0deg,transparent 0 34px,rgba(214,226,204,.022) 34px 35px)}'
    + '#akademi-demo .ak-vin{position:absolute;inset:0;z-index:0;pointer-events:none;background:radial-gradient(120% 130% at 50% 20%,transparent 46%,rgba(0,0,0,.6))}'
    + '#akademi-demo .ak-wrap{position:relative;z-index:1;width:min(1760px,96vw);margin:0 auto;padding:clamp(44px,4.6vw,76px) clamp(22px,3vw,48px)}'
    + '#akademi-demo .ak-head{max-width:920px;margin-bottom:clamp(26px,2.6vw,40px)}'
    + '#akademi-demo .ak-live{display:inline-flex;align-items:center;gap:10px;color:#a9c68b;font-family:\'Special Elite\',monospace;font-size:11px;letter-spacing:.24em;border:1px solid rgba(111,155,74,.45);padding:8px 15px;background:rgba(10,14,9,.55)}'
    + '#akademi-demo .ak-live .d{width:9px;height:9px;border-radius:50%;background:#6f9b4a;box-shadow:0 0 0 0 rgba(111,155,74,.6);animation:ak-pulse 1.6s ease-out infinite}'
    + '@keyframes ak-pulse{0%{box-shadow:0 0 0 0 rgba(111,155,74,.55)}70%{box-shadow:0 0 0 10px rgba(111,155,74,0)}100%{box-shadow:0 0 0 0 rgba(111,155,74,0)}}'
    + '#akademi-demo h2{margin:16px 0 10px;font-family:\'Playfair Display\',serif;font-size:clamp(34px,4.1vw,58px);font-weight:800;line-height:1.02;letter-spacing:-.015em;color:#f6efe0}'
    ...
    + '#akademi-demo .ak-sub{margin:0;color:#adb6ab;font-size:15px;line-height:1.65;max-width:62ch}'
    + '#akademi-demo .ak-work{display:grid;grid-template-columns:.88fr 1.12fr;gap:clamp(26px,3vw,54px);align-items:start}'
    // SOL — eğitim sicili
    + '#akademi-demo .ak-prog{border:1px solid rgba(111,155,74,.28);background:rgba(9,12,9,.68);backdrop-filter:blur(4px)}'
    + '#akademi-demo .ak-ptop{display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid rgba(111,155,74,.22)}'
    + '#akademi-demo .ak-ptop b{font-family:\'Special Elite\',monospace;font-weight:400;font-size:11.5px;letter-spacing:.2em;color:#a9c68b}'
    + '#akademi-demo .ak-ptop span{font-family:\'Special Elite\',monospace;font-size:11.5px;letter-spacing:.14em;color:#e6c478}'
    + '#akademi-demo .ak-mod{padding:12px 20px 4px;font-family:\'Special Elite\',monospace;font-size:10px;letter-spacing:.22em;color:#6d7a66}'
    + '#akademi-demo .ak-les{display:flex;align-items:center;gap:13px;width:100%;text-align:left;background:none;border:0;border-top:1px solid rgba(214,226,204,.05);padding:12px 20px;cursor:pointer;transition:background .2s}'
    + '#akademi-demo .ak-les:hover{background:rgba(111,155,74,.07)}'
    + '#akademi-demo .ak-les .n{flex:0 0 26px;height:26px;border-radius:50%;display:grid;place-items:center;font-family:\'Special Elite\',monospace;font-size:11px;color:#8b9683;border:1px solid rgba(214,226,204,.22);transition:background .3s,border-color .3s}'
    + '#akademi-demo .ak-les .t{flex:1;color:#c9d1c3;font-size:14.5px;min-width:0}'
    + '#akademi-demo .ak-les .s{flex:0 0 auto;font-size:12px;color:#5d675a;font-family:\'Special Elite\',monospace;letter-spacing:.06em}'
    + '#akademi-demo .ak-les.lock{cursor:default}'
    + '#akademi-demo .ak-les.lock .t{color:#79817a}'
    + '#akademi-demo .ak-les.open .n{background:#9E2B23;border-color:#9E2B23;color:#f4d9c9}'
    + '#akademi-demo .ak-les.act{background:rgba(111,155,74,.1)}'
    + '#akademi-demo .ak-les.act .t{color:#f4ecd8}'
    + '#akademi-demo .ak-les.done .n{background:#4d6b34;border-color:#6f9b4a;color:#e8f2dc}'
    + '#akademi-demo .ak-les.done .t{color:#9fb18f}'
    + '#akademi-demo .ak-les.pop .n{animation:ak-unlock .7s ease}'
    + '@keyframes ak-unlock{0%{transform:scale(1)}40%{transform:scale(1.45);box-shadow:0 0 0 8px rgba(111,155,74,.25)}100%{transform:scale(1)}}'
    ...
    + '#akademi-demo .ak-note{padding:12px 20px;border-top:1px solid rgba(214,226,204,.06);font-family:\'Special Elite\',monospace;font-size:10.5px;letter-spacing:.06em;color:#6d7a66;min-height:16px}'
    + '#akademi-demo .ak-cta{display:flex;flex-wrap:wrap;gap:12px 20px;align-items:center;margin-top:18px}'
    + '#akademi-demo .ak-btn{cursor:pointer;border:0;display:inline-flex;align-items:center;gap:10px;background:linear-gradient(110deg,#a77d35,#d8b26a 50%,#c19a52);color:#171207;font-family:\'Special Elite\',monospace;font-weight:700;font-size:13.5px;letter-spacing:.14em;padding:16px 28px;text-decoration:none;transition:transform .18s,box-shadow .18s}'
    ...
    // SAĞ — video karesi
    + '#akademi-demo .ak-frame{position:relative;border:1px solid rgba(193,154,82,.34);background:linear-gradient(165deg,#0b100c,#080b08 60%,#0a0d09);aspect-ratio:16/9.6;min-height:400px;overflow:hidden;box-shadow:0 40px 90px -40px rgba(0,0,0,.9)}'
    ...
    + '#akademi-demo .ak-meta{position:absolute;top:34px;left:22px;right:22px;display:flex;justify-content:space-between;font-family:\'Special Elite\',monospace;font-size:10.5px;letter-spacing:.18em;color:#8b9683;z-index:2}'
    ...
    // ders sonu kartı
    + '#akademi-demo .ak-end{position:absolute;inset:0;display:grid;place-items:center;background:rgba(7,10,8,.82);backdrop-filter:blur(3px);opacity:0;pointer-events:none;transition:opacity .5s;z-index:4}'
    ...
    + '#akademi-demo .ak-end p{margin:0 0 18px;font-family:\'Special Elite\',monospace;font-size:12px;letter-spacing:.12em;color:#a9c68b}'
    ...
    + '#akademi-demo .ak-under{display:flex;justify-content:space-between;gap:14px;margin-top:14px;font-family:\'Special Elite\',monospace;font-size:11px;letter-spacing:.12em;color:#6d7a66}'
    + '@media(max-width:900px){#akademi-demo .ak-work{grid-template-columns:1fr}#akademi-demo .ak-frame{min-height:300px}}'
  ...
  function render(mount) {
    ...
    mount.innerHTML =
      ...
      + '<div class="ak-wrap">'
      + '<div class="ak-head">'
      + '<div class="ak-live"><span class="d"></span>AJAN AKADEMİSİ · 9 DERS · SERTİFİKALI</div>'
      + '<h2>Ajan Akademisi’ne <span class="g">kabul edildin.</span></h2>'
      + '<p class="ak-sub">İlk ders açık — başlat; bölümler dolsun, altyazı aksın, sıradaki dersin kilidi kırılsın. Dokuz dersin sonunda: sertifika ve yayında bir kanal.</p>'
      + '</div>'
      + '<div class="ak-work">'
      + '<div>'
