...
(function () {
  ...
  var CSS = ''
    ...
    + '#akademi-demo .ak-wrap{position:relative;z-index:1;width:min(1660px,94vw);margin:0 auto;padding:clamp(28px,3vw,46px) clamp(22px,3vw,48px)}'
    + '#akademi-demo .ak-head{max-width:920px;margin-bottom:clamp(18px,2vw,28px)}'
    ...
    + '#akademi-demo h2{margin:14px 0 8px;font-family:\'Playfair Display\',serif;font-size:clamp(28px,3.2vw,44px);font-weight:800;line-height:1.04;letter-spacing:-.015em;color:#f6efe0}'
    ...
    // SOL — eğitim sicili
    + '#akademi-demo .ak-prog{border:1px solid rgba(193,154,82,.3);background:rgba(10,10,15,.68);backdrop-filter:blur(4px)}'
    ...
    + '#akademi-demo .ak-mod{padding:9px 18px 3px;font-family:\'Special Elite\',monospace;font-size:9.5px;letter-spacing:.22em;color:#77705c}'
    ...
    + '#akademi-demo .ak-les .s{flex:0 0 auto;font-size:11px;color:#62604f;font-family:\'Special Elite\',monospace;letter-spacing:.06em}'
    ...
    + '#akademi-demo .ak-note{padding:9px 18px;border-top:1px solid rgba(230,220,196,.06);font-family:\'Special Elite\',monospace;font-size:10px;letter-spacing:.06em;color:#77705c;min-height:14px}'
