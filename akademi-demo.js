...
(function () {
  ...
  var CSS = ''
    ...
    + '@media(max-width:760px){#akademi-demo .ak-work{grid-template-columns:1fr}#akademi-demo .ak-work>div{min-width:0}#akademi-demo .ak-frame{min-height:300px}#akademi-demo .ak-video{order:-1}}'
    + '@media(max-width:640px){'
      ...
      + '#akademi-demo .ak-frame{aspect-ratio:auto;flex:none;height:238px;min-height:0}'
