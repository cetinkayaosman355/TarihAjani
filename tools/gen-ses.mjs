...
const SCRIPTS = [
  { id: 'fetih', text: 'Yıl, bin dört yüz elli üç. Elli üç gündür surların dibinde bekleyen ordunun sabrı tükenmek üzere. Şafak sökerken devasa topun gürleyişiyle Topkapı surlarında ilk gedik açılır. İçeride bin yıllık bir imparatorluk, dışarıda yirmi bir yaşında bir sultan. O sabah bir şehir değil, koca bir çağ el değiştirir.' },
  { id: 'vezuv', text: 'Milattan sonra yetmiş dokuz. Sıradan bir sonbahar öğleni. Pompeii’nin çarşısı her günkü gibi kalabalık. Derken Vezüv uyanır; gökyüzünü otuz kilometrelik bir kül sütunu yarar ve öğle vakti geceye döner. Kaçmaya çalışanların üstüne kül yağar. Şehir, tam da o an, on yedi yüzyıl boyunca zamanın içinde donup kalır.' },
  { id: 'sezar', text: 'Mart’ın on beşi, milattan önce kırk dört. Roma’nın en güçlü adamı, kâhinin uyarısına aldırmadan senatoya girer. Önce togasını kavrayan bir el, ardından parlayan ilk hançer. Yirmi üç darbe iner. En güvendiği dostunu karşısında görünce fısıldar: Sen de mi? O mermer zeminde yalnızca Sezar değil, bir cumhuriyet can verir.' },
  { id: 'termopil', text: 'Milattan önce dört yüz seksen. Termopylai’nin dar geçidi. Bir yanda tarihin gördüğü en büyük ordu, diğer yanda yalnızca üç yüz Spartalı. Persler haber yollar: Silahlarınızı bırakın. Kral Leonidas gülümser ve yanıtı efsane olur: Gelin, alın. Üç gün boyunca imkânsızı savunurlar; hepsi ölür ama bıraktıkları söz tarihe kazınır.' },
  { id: 'bagdat', text: 'Bin iki yüz elli sekiz. Dünyanın bilgi başkenti Bağdat, Moğol ordusunun önünde diz çöker. Şehir yanarken Bilgelik Evi’nin binlerce el yazması Dicle’ye atılır. Anlatılır ki nehir günlerce mürekkepten simsiyah, kandan kızıl akar. Bir gecede yalnızca bir şehir değil, yüzyılların biriktirdiği akıl sulara karışır.' },
  { id: 'otzi', text: 'Alp Dağları, beş bin üç yüz yıl önce. Bir adam karların arasında sırtından okla vurulur ve buzun içinde kaybolur. bin dokuz yüz doksan birde eriyen bir buzulda yeniden ortaya çıkar; midesindeki son yemek, damarındaki kan hâlâ oradadır. Tarihin en eski cinayet dosyası, elli üç yüzyıl sonra yeniden açılır.' }
];
