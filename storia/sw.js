...
self.addEventListener('fetch', function (e) {
  ...
  // network-first for HTML (fresh app), cache-first for static assets
  var isHTML = e.request.mode === 'navigate' || /\.html$/.test(url.pathname) || url.pathname === '/storia/';
  if (isHTML) {
    e.respondWith(
