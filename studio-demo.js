...
(function () {
  ...
  var CSS = ''
    ...
    + '#studio-demo .sd-wrap{position:relative;width:min(1620px,95vw);margin:0 auto;padding:clamp(44px,4.8vw,72px) clamp(20px,3.5vw,52px)}'
    + '#studio-demo .sd-head{text-align:center;max-width:820px;margin:0 auto clamp(28px,3.2vw,44px)}'
    ...
    + '#studio-demo h2{margin:0 0 13px;font-family:\'Playfair Display\',serif;font-size:clamp(36px,5.4vw,62px);font-weight:800;line-height:1.02;letter-spacing:-.01em;color:#f6efe0}'
    ...
    + '#studio-demo .sd-sub{margin:0;color:#a7adba;font-size:clamp(14px,1.1vw,16.5px);line-height:1.6}'
    ...
    + '#studio-demo .sd-btn.hero{padding:20px 46px;font-size:15px;letter-spacing:.16em;box-shadow:0 16px 50px -14px rgba(230,196,120,.5)}'
    ...
    // step A — çerçevesiz, buton merkezli
    + '#studio-demo .sd-brief{display:flex;flex-direction:column;align-items:center;gap:20px;text-align:center;padding:clamp(6px,1.5vw,16px) 0}'
    ...
    + '#studio-demo .sd-chip{cursor:pointer;border:1px solid rgba(193,154,82,.38);background:rgba(193,154,82,.05);color:#d8c79b;font-family:\'Special Elite\',monospace;font-size:12.5px;letter-spacing:.05em;padding:12px 20px;transition:all .18s}'
    ...
    // workspace — çerçevesiz, enine full; sahne büyük
    + '#studio-demo .sd-work{display:grid;grid-template-columns:.7fr 1.3fr;gap:clamp(26px,3vw,54px);align-items:stretch}'
    + '#studio-demo .sd-oh{color:#c19a52;font-family:\'Special Elite\',monospace;font-size:10.5px;letter-spacing:.2em;margin:0 0 16px}'
    + '#studio-demo .sd-line{display:flex;gap:13px;align-items:flex-start;padding:14px 0;border-bottom:1px solid rgba(193,154,82,.14);opacity:0;transform:translateY(8px);transition:opacity .45s,transform .45s}'
    ...
    + '#studio-demo .sd-line b{display:block;color:#eadfc6;font-family:\'Special Elite\',monospace;font-size:11.5px;letter-spacing:.1em;margin-bottom:4px}'
    + '#studio-demo .sd-line .pv{display:block;color:#8b93a1;font-size:13px;line-height:1.5;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}'
    + '#studio-demo .sd-tags{margin-top:18px;color:#7a8090;font-family:\'Special Elite\',monospace;font-size:11px;letter-spacing:.06em;line-height:1.7}'
    ...
    + '#studio-demo .sd-foot{display:flex;flex-wrap:wrap;gap:12px;align-items:center;justify-content:space-between;margin-top:26px}'
  ...
  function render(mount) {
    ...
    function stepA() {
      ...
      mount.querySelector('.sd-body').innerHTML =
        ...
        + '<button class="sd-btn hero" id="sd-try" style="margin-top:6px">STUDIO’YU DENE <span style="font-size:16px">▸</span></button>'
